<template>
  <div class="bg-white/80 backdrop-blur-sm rounded-3xl p-6 shadow-xl border border-white/30">
    ...
    <div class="flex flex-col sm:flex-row items-center justify-between gap-4 mb-8">
      ...
      <select 
        v-model="sortBy" 
        class="bg-white/60 border border-gray-200 rounded-full px-4 py-2 text-sm font-medium text-gray-700 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent"
      >
    ...
    <div v-if="filteredProducts.length === 0" class="text-center py-16">
      ...
      <button 
        ...
        class="bg-gradient-to-r from-pink-500 to-rose-500 text-white px-6 py-3 rounded-full font-semibold hover:shadow-lg transition-all duration-300"
      >
...
const getCategoryLabel = (categoryKey) => {
  const categoryLabels = {
    ...
    aretes: 'Aretes para Mujer',
    pulseras: 'Pulseras Elegantes',
    anillos: 'Anillos para Mujer',
    relojes: 'Relojes Femeninos',
