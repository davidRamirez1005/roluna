    ...
    <button
      ...
      :class="[
        ...
        active === cat.key 
          ...
          : 'bg-white/60 text-gray-700 border border-gray-200 hover:bg-white hover:shadow-md hover:border-blue-300'
      ]"
    ...
    >
      ...
      <div :class="[
        ...
        <i :class="[
          cat.icon || 'fas fa-box',
          'text-sm',
          active === cat.key ? 'text-white' : 'text-blue-600'
        ]"></i>
      </div>
      ...
      <!-- Efecto hover -->
      <div class="absolute inset-0 rounded-2xl bg-gradient-to-r from-blue-500/10 to-indigo-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
    </button>
  </nav>
</template>
